...
include ("../classes/WorkForm.php");

$form = new WorkForm();
$form->ifEmptyField($form->getWorkFields());
$form->validateEmail();
$error = $form->getErrorMSG();

if(empty($error)){
    $msg = "Name: ".$_POST['name'].", Email: ".$_POST['email'].", Phone: ".$_POST['phone'].", Subject: Praca, Description:".$_POST['description'].", File: ".$_FILES['file']['name'];
